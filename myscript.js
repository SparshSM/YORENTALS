function getAreas(cityid) {
    ...
    xhttp.open("GET", "sendcityid.php?cityid=" + cityid, true);
    xhttp.send();
}
...
function storeAreaid(areaid) {
    ...
    alert(areaids);
    document.getElementById('areaid').value = areaids;
}
...
function add_rental_areas() {
    ...
    xhttp.open("GET", "areas_choose_action.php?area_ids=" + areaids + "&cityid=" + cityid, true);
    xhttp.send();
}
